...
class BottomSheetUtils {
  ...
  static Future<dynamic> productDetailsBottomSheet(BuildContext context, Map<String, dynamic> product) {
  ...
  // -- Product Details Bottom Sheet
  static Future<dynamic> productReviewBottomSheet(BuildContext context, List<Map<String, dynamic>> reviews) {
    final screenHeight = MediaQuery.of(context).size.height;
    return showModalBottomSheet(
      context: context,
